...
fixed_param_val=[1400,0.246,1,1,1,0,2616];
lb=[1384, 0.240, 0.8, 0.8, 1.16, 0.00, 2615];
ub=[1420, 0.252, 1.3, 1.3, 1.24, 1.00, 2619];
...
figtitle=sprintf(['fixed=[',repmat('%d,',size(fixed)),'],fixedparamval=[',repmat('%g,',size(fixed)),'],kevindata,threshold=%g,tskip=%d,xskip=%d',',10'],fixed,fixed_param_val,threshold,t_skip,x_skip);
