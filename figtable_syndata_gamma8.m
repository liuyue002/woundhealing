...
t = tiledlayout(4,5);
%% rdk
load('/home/liuy1/Documents/woundhealing/simulations/woundhealing_1d_20230823_154719_D0=3000,r=0.15,alpha=1,beta=1,gamma=8,n=0,k=2300.0,dt=0.0333_noise=400,fixed=[0,0,1,1,1,1,0,],fixedparamval=[1575,0.36,1,1,1,0,2351,],threshold=-1,tskip=1,xskip=1,2.mat');
...
%% rdnk
load('/home/liuy1/Documents/woundhealing/simulations/woundhealing_1d_20230823_154719_D0=3000,r=0.15,alpha=1,beta=1,gamma=8,n=0,k=2300.0,dt=0.0333_noise=400,fixed=[0,0,1,1,1,0,0,],fixedparamval=[2182,0.34,1,1,1,0.12,2364,],threshold=-1,tskip=1,xskip=1,3.mat')
param_names={'D_0','r','\alpha','\beta','\gamma','\eta','K'};
figure(figg);
param_inds=[1,2,7,6];
nexttile;
...
%% rdgk
load('/home/liuy1/Documents/woundhealing/simulations/woundhealing_1d_20230823_154719_D0=3000,r=0.15,alpha=1,beta=1,gamma=8,n=0,k=2300.0,dt=0.0333_noise=400,fixed=[0,0,1,1,0,1,0,],fixedparamval=[2969,0.15,1,1,8.7,0,2290,],threshold=-1,tskip=1,xskip=1,4.mat')
param_names={'D_0','r','\alpha','\beta','\gamma','\eta','K'};
figure(figg);
param_inds=[1,2,7,5];
nexttile;
...
%%
saveas(figg,'figure/syndata_figtable_gamma8.fig');
saveas(figg,'figure/syndata_figtable_gamma8.eps','epsc');
saveas(figg,'figure/syndata_figtable_gamma8.png');