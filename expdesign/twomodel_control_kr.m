...
filename=sprintf('simulations/twomodel_control_ukr_%s_alpha=%.2f,omega=%.2f',string(datetime,'yyyyMMdd_HHmmss'),alpha,omega);
makeplot=true;
...
for iter=1:maxiter
    [Js(iter),Jcontrols(iter),Jmodels(iter),C,Lambda]=J_ukr(C0,T,tfine,uknum,r1,d1,gamma1,K1,r2,d2,gamma2,K2,alpha,bangbang);
