...
fixed_param_val=[916.8169,0.406174225,1,1,0.6307844,0,2561.2255];
lb=[905, 0.395, 0.8, 0.8, 0.61, 0.105, 2559];
ub=[930, 0.415, 1.3, 1.3, 0.66, 1.115, 2564];
...
figtitle=sprintf(['fixed=[',repmat('%d,',size(fixed)),'],fixedparamval=[',repmat('%g,',size(fixed)),'],kevindata,threshold=%g,tskip=%d,xskip=%d',',15'],fixed,fixed_param_val,threshold,t_skip,x_skip);
